...
export type CrmSession = { id: string; role: CrmRole };
...
export function isValidRole(role: any): role is CrmRole {
  return role === "superadmin" || role === "admin" || role === "staff" || role === "member";
}
